...
const PricingPlans = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 border border-b-1 border-gray-200 dark:border-gray-700">
  ...
  {plans.map((plan) => (
    ...
    >
      <h3 className="text-xl font-semibold text-center mb-2 text-gray-900 dark:text-gray-200">{plan.name}</h3>
      <p className="text-2xl font-bold text-center mb-4 text-gray-900 dark:text-gray-200">{plan.price}</p>
